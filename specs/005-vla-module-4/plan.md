...
**Primary Technologies (to be documented)**: OpenAI Whisper, Cognitive Planning (LLM/Prompt Engineering), ROS 2 Actions, NVIDIA Isaac Sim (as simulation environment)
