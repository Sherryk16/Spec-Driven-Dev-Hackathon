...
2.  **Run the embedding script from the `backend` directory:**
    ...
    ```
    This script will parse the Markdown files from the `frontend/docs` directory, chunk them, generate embeddings using the OpenAI API, and upload them to Qdrant.
