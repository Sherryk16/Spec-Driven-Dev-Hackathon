...
This document records the decisions made for key technical clarifications during the planning phase of the Digital Twin book module (`003-digital-twin-module-2`).

---

## 1. Gazebo Version Selection

- **Need**: Determine the correct version of Gazebo to use for a book targeting the ROS 2 Humble Hawksbill LTS release.
